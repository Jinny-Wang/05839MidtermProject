...
// setup fill color
                                var cValue = function(d) { return d.host_identity_verified;},
                                    color = d3.scale.category10();

// add the graph canvas to the body of the webpage
                                var svg = d3.select("#host_scatter").append("svg")
...
// add the tooltip area to the webpage
  ...
  // change string (from CSV) into number format
                                    data.forEach(function(d) {
                                        d.host_id = +d.host_id;
                                        d.host_response_time = +d.host_response_time;
  ...
  // draw dots
                                    ...
                                    .enter().append("circle")
                                        .attr("class", "dot")
                                        .attr("r", function(d) {return d.host_response_time*1.5 + 3})
                                        .attr("cx", xMap)
                                        .attr("cy", yMap)
  ...
  // draw legend text
                                    legend.append("text")
                                        ...
                                        .attr("dy", ".35em")
                                        .style("text-anchor", "end")
                                        .text(function(d) { return "Host Identity verified: " + d;})
                                  });
